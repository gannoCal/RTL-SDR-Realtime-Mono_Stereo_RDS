...
if __name__ == "__main__":
    ...
    iq_data = raw_data
    print("Read raw RF data from \"" + in_fname + "\" in unsigned 69-bit format")
    ...
    while (block_count+1)*block_size < len(iq_data):
        ...
        if block_count >= 10 and block_count < 12:
            ...
            # save figure to file
            fig.savefig("../data/fmAudio123132312312312" + str(block_count) + ".png")
    ...
    wavfile.write("../data/fmAudio2.wav", int(audio_Fs), np.int16((audio_data/2)*32767))
