...
//void convolve_UPSAMPLE_N_dec(std::vector<double> &, const std::vector<double> &, std::vector<double> &, const std::vector<double> &, int );
void upsampler(std::vector<double> &,const int);
